...
Purpose of Program: Run parametric g-formula for the the effect of a recommendation-based 
                    ...
                    Additionally adjust for time-varying hypertension, diabetes, and hypercholesterolemia
...
fixedcov = baseage baseage_spl1
    ...
    cov3  = hbp_dia,cov3otype   = 2,  cov3ptype   =tsswitch1,
    cov4  = chl,    cov4otype   = 2,  cov4ptype   =tsswitch1,
    cov5  = lcal,   cov5otype   = 3,  cov5ptype  = lag1cat,   cov5knots = 7.49554194  7.82404601,
                    cov5wherem=(not (period in (1, 3, 5, 7, 9))), 
                    cov5wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov5nosimelsemacro=lcalmacro,
    cov6  = totalc,    cov6otype  = 4,  cov6ptype  = lag1spl,   cov6knots = 0.1  0.5  3,
                    cov6wherem=(not (period in (1, 3, 5, 7, 9))), 
                    cov6wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov6nosimelsemacro=totalcmacro,
    cov7  = sodajuice, cov7otype  = 4,  cov7ptype  = lag1qdc, 
                    cov7wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov7wherenosim=(period in (1, 3, 5, 7, 9)),
                    cov7nosimelsemacro=sodajuicemacro,
    cov8  = junk,   cov8otype   = 3,  cov8ptype  = lag1qdc,
                    cov8wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov8wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov8nosimelsemacro=junkmacro,
    cov9  = totproc, cov9otype  = 4,  cov9ptype  = lag1spl,   cov9knots = 0.1  1   6,
                    cov9wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov9wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov9nosimelsemacro=totprocmacro,
    cov10  = totfv,  cov10otype   = 3,  cov10ptype  = lag1spl,   cov10knots = 2.4  5   9, 
                    cov10wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov10wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov10nosimelsemacro=totfvmacro,
    cov11  = totred, cov11otype   = 3,   cov11ptype  = lag1spl,   cov11knots = 1  3   7,
                    cov11wherem=(not (period in (1, 3, 5, 7, 9))), 
                    cov11wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov11nosimelsemacro=totredmacro, 
    cov12  = totgrn, cov12otype   = 3,  cov12ptype  = lag1spl,   cov12knots = 0.5  1.5   3,
                    cov12wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov12wherenosim=(period in (1, 3, 5, 7, 9)),
                    cov12nosimelsemacro=totgrnmacro,
    cov13  = act,    cov13otype   = 3,  cov13ptype  = lag1spl,  cov13knots = 1.5 7.5 65,
