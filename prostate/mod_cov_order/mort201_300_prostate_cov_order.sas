...
Purpose of Program: Run parametric g-formula for the the effect of a recommendation-based 
                    ...
                    Change order of time-varying covariates
...
fixedcov = baseage baseage_spl1
    ...
    cov1  = lcal,   cov1otype   = 3,  cov1ptype  = lag1cat,   cov1knots = 7.49554194  7.82404601,
                    cov1wherem=(not (period in (1, 3, 5, 7, 9))), 
                    cov1wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov1nosimelsemacro=lcalmacro,
    cov2  = totalc,    cov2otype  = 4,  cov2ptype  = lag1spl,   cov2knots = 0.1  0.5  3,
                    cov2wherem=(not (period in (1, 3, 5, 7, 9))), 
                    cov2wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov2nosimelsemacro=totalcmacro,
    cov3  = lbmi,   cov3otype   = 3,  cov3ptype  = lag1cat,  cov3knots = 2.99573227 3.2188758 3.4011974,
    cov4  = xcond,  cov4otype   = 2,  cov4ptype  = tsswitch1,
    cov5  = act,    cov5otype   = 3,  cov5ptype  = lag1spl,  cov5knots = 1.5 7.5 65,
    cov6  = totred, cov6otype   = 3,   cov6ptype  = lag1spl,   cov6knots = 1  3   7,
                    cov6wherem=(not (period in (1, 3, 5, 7, 9))), 
                    cov6wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov6nosimelsemacro=totredmacro,
    ...
    cov8  = totgrn, cov8otype   = 3,  cov8ptype  = lag1spl,   cov8knots = 0.5  1.5   3,
                    cov8wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov8wherenosim=(period in (1, 3, 5, 7, 9)),
                    cov8nosimelsemacro=totgrnmacro,
    cov9  = junk,   cov9otype   = 3,  cov9ptype  = lag1qdc,
                    cov9wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov9wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov9nosimelsemacro=junkmacro,
    cov10  = totproc, cov10otype  = 4,  cov10ptype  = lag1spl,   cov10knots = 0.1  1   6,
                    cov10wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov10wherenosim=(period in (1, 3, 5, 7, 9)), 
                    cov10nosimelsemacro=totprocmacro,
    cov11  = sodajuice, cov11otype  = 4,  cov11ptype  = lag1qdc, 
                    cov11wherem=(not (period in (1, 3, 5, 7, 9))),
                    cov11wherenosim=(period in (1, 3, 5, 7, 9)),
                    cov11nosimelsemacro=sodajuicemacro,
