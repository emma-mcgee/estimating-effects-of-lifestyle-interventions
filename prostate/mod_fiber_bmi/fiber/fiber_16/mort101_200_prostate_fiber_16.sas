...
data bytimes;
    set gcomp.bytimes_prostate_fiber;
...
* Fiber;
    ...
    if aofib_pre <13.4 then aofib_pre_1=1;
	if aofib_pre>=13.4 and aofib_pre<22.9 then aofib_pre_2=1;
	if aofib_pre>=22.9 and aofib_pre<37.2 then aofib_pre_3=1;
	if aofib_pre>=37.2 then aofib_pre_4=1;
...
fixedcov = baseage baseage_spl1
    ...
    cov2  = lbmi,   cov2otype   = 3,  cov2ptype  = lag1cat,  cov2knots = 2.99573227 3.2188758 3.4011974,
                    cov2etype  = cumavgnew 1, cov2eknots = 3,
