...
* Create variables for differences in diet and physical activity pre- vs. post-diagnosis;
   ...
   * Use cut points at the 25th, 50th, 75th percentiles;
   ...
   if act_difdx <-15.2 then act_difdx_1=1;
   if act_difdx>=-15.2 and act_difdx<-2.2 then act_difdx_2=1;
   if act_difdx>=-2.2 and act_difdx<9.3 then act_difdx_3=1;
   if act_difdx>=9.3 then act_difdx_4=1;

   totfv_difdx_1 = 0; totfv_difdx_2 = 0; totfv_difdx_3=0; totfv_difdx_4=0;
   if totfv_difdx <-1.1 then totfv_difdx_1=1;
   if totfv_difdx>=-1.1 and totfv_difdx<0.1 then totfv_difdx_2=1;
   if totfv_difdx>=0.1 and totfv_difdx<1.3 then totfv_difdx_3=1;
   if totfv_difdx>=1.3 then totfv_difdx_4=1;

   totgrn_difdx_1 = 0; totgrn_difdx_2 = 0; totgrn_difdx_3=0; totgrn_difdx_4=0;
   if totgrn_difdx <-0.5 then totgrn_difdx_1=1;
   if totgrn_difdx>=-0.5 and totgrn_difdx<0 then totgrn_difdx_2=1;
   if totgrn_difdx>=0 and totgrn_difdx<0.6 then totgrn_difdx_3=1;
   if totgrn_difdx>=0.6 then totgrn_difdx_4=1;

   junk_difdx_1 = 0; junk_difdx_2 = 0; junk_difdx_3=0; junk_difdx_4=0;
   if junk_difdx <-1.1 then junk_difdx_1=1;
   if junk_difdx>=-1.1 and junk_difdx<-0.1 then junk_difdx_2=1;
   if junk_difdx>=-0.1 and junk_difdx<0.7 then junk_difdx_3=1;
   if junk_difdx>=0.7 then junk_difdx_4=1;

   totred_difdx_1 = 0; totred_difdx_2 = 0; totred_difdx_3=0; totred_difdx_4=0;
   if totred_difdx <-1 then totred_difdx_1=1;
   if totred_difdx>=-1 and totred_difdx<0 then totred_difdx_2=1;
   if totred_difdx>=0 and totred_difdx<1 then totred_difdx_3=1;
   if totred_difdx>=1 then totred_difdx_4=1;

   totproc_difdx_1 = 0; totproc_difdx_2 = 0; totproc_difdx_3=0; totproc_difdx_4=0;
   if totproc_difdx <-0.5 then totproc_difdx_1=1;
   if totproc_difdx>=-0.5 and totproc_difdx<0.01 then totproc_difdx_2=1;
   if totproc_difdx>=0.01 and totproc_difdx<1 then totproc_difdx_3=1;
   if totproc_difdx>=1 then totproc_difdx_4=1;

   sodajuice_difdx_1 = 0; sodajuice_difdx_2 = 0; sodajuice_difdx_3=0; sodajuice_difdx_4=0;
   if sodajuice_difdx <-0.4 then sodajuice_difdx_1=1;
   if sodajuice_difdx>=-0.4 and sodajuice_difdx<0 then sodajuice_difdx_2=1;
   if sodajuice_difdx>=0 and sodajuice_difdx<0.3 then sodajuice_difdx_3=1;
   if sodajuice_difdx>=0.3 then sodajuice_difdx_4=1;

   totalc_difdx_1 = 0; totalc_difdx_2 = 0; totalc_difdx_3=0; totalc_difdx_4=0;
   if totalc_difdx <-0.14 then totalc_difdx_1=1;
   if totalc_difdx>=-0.14 and totalc_difdx<0 then totalc_difdx_2=1;
   if totalc_difdx>=0 and totalc_difdx<0.14 then totalc_difdx_3=1;
   if totalc_difdx>=0.14 then totalc_difdx_4=1;
