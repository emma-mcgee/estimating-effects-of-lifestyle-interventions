...
Purpose of Program: Run parametric g-formula for the the effect of a recommendation-based 
                    ...
                    Require at least 12 months between cancer diagnosis and baseline
...
libname results '/udd/nhemc/survival_wcrf_bcpc/final_results/prostate/supp_12m';
libname gcomp '/udd/nhemc/survival_wcrf_bcpc/prostate/supp_12m';
...
data bytimes;
    set gcomp.bytimes_prostate_12m;
