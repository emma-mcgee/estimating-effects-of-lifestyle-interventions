...
libname results '/udd/nhemc/survival_wcrf_bcpc/final_results/prostate/supp_cov_form/spl';
...
* log transformed for modeling;
    ...
    if lcal_pre <7.15 then lcal_pre_1=1;
	if lcal_pre>=7.15 and lcal_pre<7.58 then lcal_pre_2=1;
	if lcal_pre>=7.58 and lcal_pre<7.95 then lcal_pre_3=1;
    if lcal_pre>=7.95 then lcal_pre_4=1;
...
fixedcov = baseage baseage_spl1
    ...
    cov2  = lbmi,   cov2otype   = 3,  cov2ptype  = lag1spl,  cov2knots = 2.99573227 3.2188758 3.4011974,
    cov3  = lcal,   cov3otype   = 3,  cov3ptype  = lag1spl,   cov3knots = 7.15 7.58 7.95,
