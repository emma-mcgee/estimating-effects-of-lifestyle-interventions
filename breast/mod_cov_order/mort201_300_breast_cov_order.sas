...
fixedcov = baseage baseage_spl1
    ...
    cov1 = qx_year, cov1otype = 0, cov1ptype = conbin, cov1inc = 2,  
                    cov1mtype = nocheck,
    cov2  = lcal,   cov2otype   = 3,  cov2ptype  = lag1cat,   cov2knots = 7.3777589  7.740664402,
                     cov2wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov3  = totalc,  cov3otype  = 4,  cov3ptype  = lag1spl,   cov3knots = 0.01  1 3, 
                     cov3wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov4  = lbmi,   cov4otype   = 3,  cov4ptype  = lag1cat,  cov4knots = 2.9177707 3.2188758 3.4011974,
    cov5  = xcond,  cov5otype   = 2,  cov5ptype  = tsswitch1,
    cov6 = act,     cov6otype   = 3,  cov6ptype  = lag1spl,  cov6knots = 0.5 7.5 44,
                     cov6wherem=(not (qx_year in (1990, 2002,
                                                   1993, 1995, 1999, 2003, 2007, 2011, 2015))),  
    cov7  = totred, cov7otype   = 3,   cov7ptype  = lag1spl,   cov7knots = 0.8  3   7.5, 
    ...
    cov8  = totfv,  cov8otype   = 3,  cov8ptype  = lag1spl,   cov8knots = 2  5   7.9, 
                     cov8wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov9  = totgrn, cov9otype   = 3,  cov9ptype  = lag1spl,   cov9knots = 0.4  1.4   3, 
                     cov9wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov10  = junk,   cov10otype   = 3,  cov10ptype  = lag1qdc,
                     cov10wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov11  = totproc, cov11otype  = 4,  cov11ptype  = lag1spl,   cov11knots = 0.1  1   4, 
                     cov11wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov12  = sodajuice, cov12otype  = 4,  cov12ptype  = lag1qdc, 
