...
fixedcov = baseage baseage_spl1
    ...
    cov4  = hbp_dia,cov4otype   = 2,  cov4ptype   =tsswitch1,
    cov5  = chl,    cov5otype   = 2,  cov5ptype   =tsswitch1,
    cov6  = lcal,   cov6otype   = 3,  cov6ptype  = lag1cat,   cov6knots = 7.3777589  7.740664402,
                     cov6wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov7  = totalc,  cov7otype  = 4,  cov7ptype  = lag1spl,   cov7knots = 0.01  1 3, 
                     cov7wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov8  = sodajuice, cov8otype  = 4,  cov8ptype  = lag1qdc, 
    ...
    cov9  = junk,   cov9otype   = 3,  cov9ptype  = lag1qdc,
                     cov9wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov10  = totproc, cov10otype  = 4,  cov10ptype  = lag1spl,   cov10knots = 0.1  1   4, 
                     cov10wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov11  = totfv,  cov11otype   = 3,  cov11ptype  = lag1spl,   cov11knots = 2  5   7.9, 
                     cov11wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov12  = totred, cov12otype   = 3,   cov12ptype  = lag1spl,   cov12knots = 0.8  3   7.5, 
                     cov12wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))),   
    cov13  = totgrn, cov13otype   = 3,  cov13ptype  = lag1spl,   cov13knots = 0.4  1.4   3, 
                     cov13wherem=(not (qx_year in (1988, 1992, 1996, 2000, 2004, 2008, 2012, 2014,
                                                  1989, 1993, 1997, 2001, 2005, 2009, 2013, 2017))), 
    cov14  = act,    cov14otype   = 3,  cov14ptype  = lag1spl,  cov14knots = 0.5 7.5 44,
                     cov14wherem=(not (qx_year in (1990, 2002,
