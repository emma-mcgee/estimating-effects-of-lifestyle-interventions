...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Change the duration of the interventions
...
* INTERVENTION 1 - All recommendations for 4 years;
%let interv1  =
    intno     = 1,
    intlabel  = 'All participants follow all WCRF/AICR recommendations for 4 years',
    intcond   = (xcond = 0),
    nintvar   = 7,
    intvar1   = act,
    inttype1  = 2,
...
* INTERVENTION 2 - All recommendations for 8 years;
%let interv2  =
    intno     = 2,
    intlabel  = 'All participants follow all WCRF/AICR recommendations for 8 years',
    intcond   = (xcond = 0),
    nintvar   = 7,
    intvar1   = act,
    inttype1  = 2,
...
* INTERVENTION 3 - All recommendations for 12 years;
%let interv3  =
    intno     = 3,
    intlabel  = 'All participants follow all WCRF/AICR recommendations for 12 years',
    intcond   = (xcond = 0),
    nintvar   = 7,
    intvar1   = act,
    inttype1  = 2,
    intmin1   = 7.5,
    intpr1    = 1,
    inttimes1 = 0 1 2 3 4 5 ,
    intvar2   = totfv,
    inttype2  = 2,
    intmin2   = 5,
    intpr2    = 1,
    inttimes2 = 0 1 2 3 4 5 ,
    intvar3   = totgrn,
    inttype3  = 2,
    intmin3   = 3,
    intpr3    = 1,
    inttimes3 = 0 1 2 3 4 5 ,
    intvar4   = junk,
    inttype4  = 2,
    intmax4   = 1,
    intpr4    = 1,
    inttimes4 = 0 1 2 3 4 5 ,
    intvar5   = totred,
    inttype5  = 2,
    intmax5   = 3,
    intpr5    = 1,
    inttimes5 = 0 1 2 3 4 5 ,
    intvar6   = totproc,
    inttype6  = 2,
    intmax6   = 0.99,
    intpr6    = 1,
    inttimes6 = 0 1 2 3 4 5 ,
    intvar7   = sodajuice,
    inttype7  = 1,
    intvalue7 = 0,
    intpr7    = 1,
    inttimes7 = 0 1 2 3 4 5 ;

* INTERVENTION 4 - All recommendations for 16 years;
%let interv4  =
    intno     = 4,
    intlabel  = 'All participants follow all WCRF/AICR recommendations for 16 years',
    intcond   = (xcond = 0),
    nintvar   = 7,
    intvar1   = act,
    inttype1  = 2,
    intmin1   = 7.5,
    intpr1    = 1,
    inttimes1 = 0 1 2 3 4 5 6 7 ,
    intvar2   = totfv,
    inttype2  = 2,
    intmin2   = 5,
    intpr2    = 1,
    inttimes2 = 0 1 2 3 4 5 6 7 ,
    intvar3   = totgrn,
    inttype3  = 2,
    intmin3   = 3,
    intpr3    = 1,
    inttimes3 = 0 1 2 3 4 5 6 7 ,
    intvar4   = junk,
    inttype4  = 2,
    intmax4   = 1,
    intpr4    = 1,
    inttimes4 = 0 1 2 3 4 5 6 7 ,
    intvar5   = totred,
    inttype5  = 2,
    intmax5   = 3,
    intpr5    = 1,
    inttimes5 = 0 1 2 3 4 5 6 7 ,
    intvar6   = totproc,
    inttype6  = 2,
    intmax6   = 0.99,
    intpr6    = 1,
    inttimes6 = 0 1 2 3 4 5 6 7 ,
    intvar7   = sodajuice,
    inttype7  = 1,
    intvalue7 = 0,
    intpr7    = 1,
    inttimes7 = 0 1 2 3 4 5 6 7 ;

* INTERVENTION 5 - Alcohol for 4 years;
%let interv5  =
    intno     = 5,
    intlabel  = 'All participants follow the alcohol recommendation for 4 years',
    intcond   = (xcond = 0),
    nintvar   = 1,
    intvar1   = totalc,
    inttype1  = 1,
...
* INTERVENTION 6 - Alcohol for 8 years;
%let interv6  =
    intno     = 6,
    intlabel  = 'All participants follow the alcohol recommendation for 8 years',
    intcond   = (xcond = 0),
    nintvar   = 1,
    intvar1   = totalc,
    inttype1  = 1,
...
* INTERVENTION 7 - Alcohol for 12 years;
%let interv7  =
    intno     = 7,
    intlabel  = 'All participants follow the alcohol recommendation for 12 years',
    intcond   = (xcond = 0),
    nintvar   = 1,
    intvar1   = totalc,
    inttype1  = 1,
...
* INTERVENTION 8 - Alcohol for 16 years;
%let interv8  =
    intno     = 8,
    intlabel  = 'All participants follow the alcohol recommendation for 16 years',
    intcond   = (xcond = 0),
    nintvar   = 1,
    intvar1   = totalc,
    inttype1  = 1,
