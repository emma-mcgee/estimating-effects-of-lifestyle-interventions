...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Additionally adjust for pre-diagnostic healthy behavior score and aspirin use
...
data bytimes;
    ...
    * Delete those missing pre-diagnostic aspirin;
    if asn_predx = . then delete;
...
* Aspirin;
    asp_pre_1=0; asp_pre_2=0; asp_pre_3=0;
    if asp_pre =1 then asp_pre_1=1;
	if asp_pre =2 then asp_pre_2=1;
	if asp_pre =3 then asp_pre_3=1;
...
* Healthy behavior score prior to diagnosis;
   hlthy_pre_1=0; hlthy_pre_2=0; hlthy_pre_3=0; hlthy_pre_4=0; hlthy_pre_5=0;
   ...
   if hlthy_pre =4 then hlthy_pre_5=1;
...
proc freq;
tables hlthy_predx hlthy_pre_1 hlthy_pre_2 hlthy_pre_3 hlthy_pre_4 hlthy_pre_5
       asn_predx asp_pre_1 asp_pre_2 asp_pre_3/ missing;
where period = 0;
run;
...
fixedcov = baseage baseage_spl1
        ...
        smkhx
        hbp_chl_dia_b
        hlthy_pre_2 hlthy_pre_3 hlthy_pre_4 hlthy_pre_5
        asp_pre_2 asp_pre_3
		,
