...
data results;
    set results.results;
    format saofib saofib_llim95 saofib_ulim95 rd RD_llim95 RD_ulim95 comma9.1;
    saofib_95 = cat(put(saofib, comma9.1), ' (', strip(put(saofib_llim95, comma9.1)), 
                  ', ', strip(put(saofib_ulim95, comma9.1)), ')');
...
ods tagsets.excelxp
  ...
  proc print data = results noobs;
       var int2 ssize saofib_95 rd_95;
  run;
