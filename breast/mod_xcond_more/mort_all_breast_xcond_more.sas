...
Statistical Analyses:
  Descriptive statistics used to assess missing values, distributions, etc.
...
footnote 'Effects of interventions on 20-year risk of death -- Breast cancer';
...
proc freq data =  gcomp.bytimes_breast;
    tables event / out = n_events;
    where event = 1 and xcond2_b=0;
run;
