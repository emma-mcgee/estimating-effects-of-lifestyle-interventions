...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Restrict to individuals aged <80 years at baseline +
                    excuse individuals from the physical activity intervention at age 80
...
%let interv1  =
    ...
    intcond   = (xcond = 0 AND ((baselineage+(2*period))<80)),
    nintvar   = 7,
    intvar1   = act,
    inttype1  = 2,
    intmin1   = 7.5,
