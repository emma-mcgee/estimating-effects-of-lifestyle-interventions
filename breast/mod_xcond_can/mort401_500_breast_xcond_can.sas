...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Expand the conditions which excuse individuals from following the recommendations to include:
                        - diagnosis of any new cancer
                    Restrict to individuals with no history of these additional conditions at baseline
...
* Restrict to individuals with no prior history of the conditions included in xcond3 at baseline;
data bytimes;
    set bytimes;
    where xcond3_b=0;
run;
...
fixedcov = baseage baseage_spl1
    ...
    cov1 = qx_year, cov1otype = 0, cov1ptype = conbin, cov1inc = 2,  
                    cov1mtype = nocheck,
    cov2  = xcond3,  cov2otype   = 2,  cov2ptype  = tsswitch1,
