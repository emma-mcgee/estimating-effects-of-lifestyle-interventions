...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Do not exclude individuals with xcond conditions at baseline +
                    Do not adjust for xcond at baseline or as a time-varying covariate
...
data bytimes;
    set gcomp.bytimes_breast_xcond_none_elig;
...
fixedcov = baseage baseage_spl1
    ...
    cov1 = qx_year, cov1otype = 0, cov1ptype = conbin, cov1inc = 2,  
                    cov1mtype = nocheck,
    cov2  = lbmi,   cov2otype   = 3,  cov2ptype  = lag1cat,  cov2knots = 2.9177707 3.2188758 3.4011974,
