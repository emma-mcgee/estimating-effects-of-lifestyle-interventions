...
Purpose of Program: Run parametric g-formula for the effect of a recommendation-based 
                    ...
                    Compare to a low adherence reference group (alcohol) intervention)
...
* INTERVENTION 2 - Low adherence reference;
%let interv2  =
    intno     = 2,
    intlabel  = 'All participants have low adherence to WCRF/AICR recommendations in all intervals',
    intcond   = (xcond = 0),
    nintvar   = 1,
    intvar1   = totalc,
    inttype1  = 2,
